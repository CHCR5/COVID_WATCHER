...
urlpatterns = [
    ...
    path('registroEmpleadoIntro/', registroEmpleadoIntro, name="registroEmpleadoIntro"),
    path('registroEmpleadoIntro2/', registroEmpleadoIntro2, name="registroEmpleadoIntro2"),
    ...
    path('registroAdministradorIntro/', registroAdministradorIntro, name="registroAdministradorIntro"),
    path('registroAdministradorIntro2/', registroAdministradorIntro2, name="registroAdministradorIntro2"),
